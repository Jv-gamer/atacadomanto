...
export default function VersionsPage() {
  const fanSpecs = [
    ...
    {
      label: "Costuras e Acabamento",
      val: "Costuras e escudos bordados de alta resistência",
    },
    {
      label: "Tecido Principal",
      val: "Poliéster Dry-Tech (Foco em durabilidade)",
    },
    {
      label: "Respirabilidade",
      val: "Média (Indicado para uso casual diário)",
    },
    {
      label: "Durabilidade em Lavagens",
      val: "Alta durabilidade de uso prolongado",
    },
  ...
  const playerSpecs = [
    {
      label: "Modelagem / Caimento",
      val: "Slim Fit (Ajustada e aerodinâmica)",
    },
    {
      label: "Costuras e Acabamento",
      val: "Escudos e marcas termoselados (Sem costura interna)",
    },
    { label: "Tecido Principal", val: "Dry-Fit Active premium texturizado" },
    {
      label: "Respirabilidade",
      val: "Máxima (Microperfurações a laser para fluxo de ar)",
    },
    {
      label: "Durabilidade em Lavagens",
      val: "Requer cuidados de lavagem especial (Ciclo delicado)",
    },
    {
      label: "Uso Ideal",
      val: "Alta performance, futebol amador/profissional e treino",
    },
  ];
    ...
    <div className="bg-bg-main py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto space-y-12 text-left">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          <span className="bg-[#0f766e]/10 text-primary text-xs font-bold font-poppins px-4.0 py-2.0 rounded-full uppercase tracking-wider">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-12">
          ...
          <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-xs flex flex-col justify-between">
            <div className="space-y-6">
              <div className="flex items-center justify-between pb-4 border-b border-gray-100">
                <div>
                  <h3 className="text-2xl font-extrabold font-poppins text-text-main">
                    Versão Torcedor
                  </h3>
                  <p className="text-xs text-text-sec font-semibold font-inter mt-1">
              ...
              <div className="space-y-3.5 pt-4">
                <h4 className="text-xs font-bold font-poppins text-text-main tracking-wider uppercase">
                  Destaques da Versão
                </h4>
            ...
            <div className="mt-8 pt-6 border-t border-gray-100 bg-[#F5F6F8]/60 p-4 rounded-xl"></div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 border border-primary/20 shadow-sm flex flex-col justify-between relative overflow-hidden">
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between pb-4 border-b border-gray-100">
                <div>
                  <h3 className="text-2xl font-extrabold font-poppins text-primary">
                    Versão Jogador
                  </h3>
                  <p className="text-xs text-text-sec font-semibold font-inter mt-1">
            ...
            <div className="mt-8 pt-6 border-t border-gray-100 bg-[#0F766E]/5 p-4 rounded-xl border border-[#0F766E]/10"></div>
          </div>
        </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="text-xs font-semibold text-text-main font-inter divide-y divide-gray-100">
                <tr>
                  <td className="px-6 py-4 bg-gray-50/50 font-bold text-text-main font-poppins">
                    Caimento / Modelagem
                  </td>
                  <td className="px-6 py-4 text-text-sec">
                    Classic Fit (Regular/Solta)
                  </td>
                  <td className="px-6 py-4 text-primary font-bold">
                    Slim Fit (Mais ajustada/Fina)
                  </td>
                </tr>
                <tr>
                  <td className="px-6 py-4 bg-gray-50/50 font-bold text-text-main font-poppins">
                  ...
                  <td className="px-6 py-4 text-text-sec">
                    Costuras Bordadas clássicas
                  </td>
                  <td className="px-6 py-4 text-text-sec">
                    Termoselados emborrachados 3D
                  </td>
                </tr>
                <tr>
                  <td className="px-6 py-4 bg-gray-50/50 font-bold text-text-main font-poppins">
                  ...
                  <td className="px-6 py-4 text-text-sec">
                    100% Poliéster standard dry
                  </td>
                  <td className="px-6 py-4 text-text-sec">
                    100% Poliéster reciclado Dry-Fit Active
                  </td>
                </tr>
                <tr>
                  <td className="px-6 py-4 bg-gray-50/50 font-bold text-text-main font-poppins">
                    Ventilação / Perfurações
                  </td>
                  <td className="px-6 py-4 text-text-sec">
                    Fios entrelaçados convencionais
                  </td>
                  <td className="px-6 py-4 text-text-sec">
                    Painéis traseiros microperfurados a laser
                  </td>
                </tr>
                <tr>
                  <td className="px-6 py-4 bg-gray-50/50 font-bold text-text-main font-poppins">
                ...
                <tr>
                  ...
                  <td className="px-6 py-4 text-text-sec">
                    Ciclo normal de máquina
                  </td>
                  <td className="px-6 py-4 text-text-sec">
                    Ciclo leve de máquina ou lavagem manual
                  </td>
                </tr>
              </tbody>
            </table>
